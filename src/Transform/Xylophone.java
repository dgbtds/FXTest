...
public class Xylophone extends Application {
    ...
    @Override public void start(final Stage stage) {
        ...
        final AudioClip bar1Note =
                new AudioClip(Xylophone.class.getResource("audio/Note1.mp3").toString());
        final AudioClip bar2Note =
                new AudioClip(Xylophone.class.getResource("audio/Note2.mp3").toString());
        final AudioClip bar3Note =
                new AudioClip(Xylophone.class.getResource("audio/Note3.mp3").toString());
        final AudioClip bar4Note =
                new AudioClip(Xylophone.class.getResource("audio/Note4.mp3").toString());
        final AudioClip bar5Note =
                new AudioClip(Xylophone.class.getResource("audio/Note5.mp3").toString());
        final AudioClip bar6Note =
                new AudioClip(Xylophone.class.getResource("audio/Note6.mp3").toString());
        final AudioClip bar7Note =
                new AudioClip(Xylophone.class.getResource("audio/Note7.mp3").toString());
        final AudioClip bar8Note =
                new AudioClip(Xylophone.class.getResource("audio/Note8.mp3").toString());
